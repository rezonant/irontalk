...
namespace Irontalk {
	[STRuntimeMetaclassDelegate(typeof(char), "Char")]
	public static class STCharClassDelegate {
		[STRuntimeMethod("cr")] public static char Cr() { return '\n'; }
		[STRuntimeMethod("space")] public static char Space() { return ' '; }
	}
	
	[STRuntimeClassDelegate(typeof(char), "Char")]
	public static class STCharDelegate {
		[STRuntimeMethod("-")]
		...
		[STRuntimeMethod("asInteger")]
		public static long AsInteger(char self)
		{
			return (long)self;
		}
	}
