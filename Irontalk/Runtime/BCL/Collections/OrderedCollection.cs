...
namespace Irontalk {
	public class OrderedCollection : List<object> {
		[STRuntimeMethod("at:")] public object At(long index)
			{ return this[(int)index - 1]; }
		[STRuntimeMethod("at:put:")] public void AtPut(long index, object value)
			{ this[(int)index + 1] = value; }
		[STRuntimeMethod("size")] public long Size()
			{ return this.Count; }
		[STRuntimeMethod("add:")] public void AddM(object value)
			{ this.Add(value); }
	}
}
